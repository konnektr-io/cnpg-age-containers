...
# Pull in the latest Debian trixie security updates at build time so the image
# does not carry known base-OS CVEs (openssl, glibc, systemd, ...) between
# upstream CloudNativePG base rebuilds.
RUN apt-get update \
